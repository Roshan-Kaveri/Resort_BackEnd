...
app.get("/getguests", async (req, res) => {
  try {
    const result = await db.query("SELECT * FROM guests"); // Assuming your table is named 'guests'
...
app.get("/getcabs", async (req, res) => {
  try {
    const result = await db.query("SELECT * FROM cab_services"); // Assuming your table is named 'guests'
    res.json(result.rows); // Send the fetched guest data as JSON response
    //  console.log(result.rows);
  } catch (err) {
    console.error("Error fetching data:", err);
...
app.get("/getresorts", async (req, res) => {
  try {
    const result = await db.query("SELECT * FROM resort"); // Assuming your table is named 'guests'
    res.json(result.rows); // Send the fetched guest data as JSON response
    //  console.log(result.rows);
  } catch (err) {
    console.error("Error fetching data:", err);
...
app.get("/getfoodordered", async (req, res) => {
  try {
    const result = await db.query("SELECT * FROM food_ordered");
    res.json(result.rows);
    //  console.log(result.rows);
  } catch (err) {
    console.error("Error fetching data:", err);
...
app.get("/getother", async (req, res) => {
  try {
    const result = await db.query("SELECT * FROM other_amenities");
    res.json(result.rows);
    //   console.log(result.rows);
  } catch (err) {
    console.error("Error fetching data:", err);
